        ...
        return (
            <div id="page-content-wrapper">
                ...
                <div class="container mt-5 ml-5">
                    <h2 class="mt-4 font-weight-bold bluehead">Selamat Datang, Guru</h2>
                    <div className="d-flex justify-content-between mt-5">
                        <div className="card-one">
                            <div className="d-flex justify-content-between mt-2">
                                ...
                                <svg width="4em" height="4em" viewBox="0 0 16 16" class="bluetext mt-4 mr-5 bi bi-person-lines-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="d-flex justify-content-between mt-2">
                                ...
                                <svg width="4em" height="4em" viewBox="0 0 16 16" class="bluetext mt-4 mr-5 bi bi-journals" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="d-flex justify-content-between mt-2">
                            ...
                            <svg width="4em" height="4em" viewBox="0 0 16 16" class="bluetext mt-4 mr-5 bi bi-bookmark-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
